...
urlpatterns = [
    ...
    path('profile/my_posts/', views.my_posts, name='my_posts'),
    path('profile/my_likes/', views.my_likes, name='my_likes'),
    ...
    path('categories/movies/shorter_movies/', views.shorter_movies, name='shorter_movies'),
    ...
    path('categories/movies/longer_movies/', views.longer_movies, name='longer_movies'),
