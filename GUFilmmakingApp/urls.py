...
urlpatterns = [
    ...
    path('categories/short_films/<slug:content_name_slug>/', views.movie, name='short_movies'),
    path('categories/bts/<slug:content_name_slug>/', views.behind_the_scenes, name='behind_the_scenes'),
